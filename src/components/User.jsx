            ...
            {response &&
                < >
                    <main className="bg-[#20293A] w-full  flex flex-col md:flex-row md:h-16 lg:h-22" onClick={closeBox}>
                        <div className="bg-[#20293A] w-24 lg:w-28 h-24 lg:h-28 pt-1.5 rounded-2xl  relative bottom-8 left-6 md:left-[9%] lg:left-[12%] xl:left-[12%]">
                            <img className="w-21 lg:w-25 mx-auto h-20 lg:h-24 rounded-2xl " src={response.avatar_url} alt="" />
                        </div>
